...
package structural.decorator.adapter;
...
class MyStringBuilder
{
    ...
    /*
    Fluent interface approach - extensible methods
    Adapter: adapts concat method to our class
    Decorator (below): aggregating StringBuilder class methods below
     */
